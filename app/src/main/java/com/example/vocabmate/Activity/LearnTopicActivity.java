    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<Topic>>() {
            ...
            public void onResponse(Call<List<Topic>> call, Response<List<Topic>> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        Toast.makeText(LearnTopicActivity.this, "Danh sách chủ đề trống", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(LearnTopicActivity.this, "Lỗi API: " + response.code(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<Topic>> call, Throwable t) {
                ...
                t.printStackTrace();
                Toast.makeText(LearnTopicActivity.this, "Lỗi khi tải danh sách chủ đề: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void displayTopics(List<Topic> topics) {
        ...
        for (Topic topic : topics) {
            ...
            view.setOnClickListener(v -> {
                Intent intent = new Intent(LearnTopicActivity.this, LearnVocabByTopicActivity.class);
