...
public class LearnRandomActivity extends AppCompatActivity {
    ...
    private void displayQuestion(Vocab vocab) {
        ...
        if (vocab.getVocabImg() != null && !vocab.getVocabImg().isEmpty()) {
            Glide.with(LearnRandomActivity.this)
    ...
    private void skipQuestion() {
        ...
        SharedPreferences sharedPreferences = LearnRandomActivity.this.getSharedPreferences("UserPrefs", Context.MODE_PRIVATE);
        ...
        apiService.saveLearnHistory(learnHistory).enqueue(new Callback<Boolean>() {
            ...
            public void onResponse(Call<Boolean> call, Response<Boolean> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null && response.body()) {
                        Toast.makeText(LearnRandomActivity.this, "", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(LearnRandomActivity.this, "", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(LearnRandomActivity.this, "" + response.message(), Toast.LENGTH_SHORT).show();
                }
                ...
                if (currentIndex < vocabList.size()) {
                    ...
                    Toast.makeText(LearnRandomActivity.this, "Bạn đã hoàn thành bài học!", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<Boolean> call, Throwable t) {
                Toast.makeText(LearnRandomActivity.this, "Không thể kết nối API!", Toast.LENGTH_SHORT).show();
            }
